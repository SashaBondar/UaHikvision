...
public class CameraBaseActivity extends Activity implements Callback, OnTouchListener{
    ...
    public final String ADDRESS = "192.168.0.64";
    public final int PORT = 8000;
    public final String USER = "admin";
    public final String PSD = "ghjnjy11";
    ...
    public void SetOnclick(View view) {
        ...
        button2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (integer > 255 || integer < 0) {
                    Toast.makeText(CameraBaseActivity.this, "Установить между 0-255", Toast.LENGTH_SHORT).show();
                    return;
                }
                boolean b = HCNetSDK.getInstance().NET_DVR_PTZPreset(m_iPlayID, SET_PRESET,
                        integer);
                if (b) {
                    Toast.makeText(CameraBaseActivity.this, "Установить успешно", Toast.LENGTH_SHORT).show();
                    app.editor.putInt("POINT", integer).commit();
                } else {
                    Toast.makeText(CameraBaseActivity.this, "Ошибка настройки", Toast.LENGTH_SHORT).show();
                }
                Log.d(TAG, "onClick: " + b);
            }
        });
        //Очистить заданную точку
        button1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (b) {
                    ...
                    Toast.makeText(CameraBaseActivity.this, "Удалить успешно", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(CameraBaseActivity.this, "Сбой очистки", Toast.LENGTH_SHORT).show();
                }
                Log.d(TAG, "onClick: " + b);
                dialog.dismiss();
            }
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int point = app.preferences.getInt("POINT", 0);
                if (point == 0) {
                    Toast.makeText(app, "Сначала установите предустановленную точку", Toast.LENGTH_SHORT).show();
                    return;
                }
                boolean b = HCNetSDK.getInstance().NET_DVR_PTZPreset(m_iPlayID, PTZCommand.GOTO_PRESET,
                        point);
